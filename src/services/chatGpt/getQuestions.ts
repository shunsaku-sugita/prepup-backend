...
import { interviewPromptByJobDescription, interviewPromptByOccupation } from "./prompts";
...
export const questionsByOccupation = async (occupation: string) => {
  ...
  export const questionsByJobDescription = async (jobDescription: string) => {
    ...
    try { 
      ...
      console.error('Error generating interview questions by job description:', error);
